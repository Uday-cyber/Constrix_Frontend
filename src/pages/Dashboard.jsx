    ...
    return (
        <div className='max-w-6xl mx-auto'>
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 ">
                <div>
                    <h1 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white mb-1"> {t("dashboard.welcomeBack", { name: user?.fullName || "User" })} </h1>
                    <p className="text-gray-500 dark:text-zinc-400 text-sm"> {t("dashboard.happeningToday")} </p>
                </div>
